...
String key1,key2;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s = new String();
            ...
            String qry="select * from emd_file where genfile='"+filedialog.getFile()+"'";
            System.out.println(filedialog.getFile()+""+qry);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String key3 = JOptionPane.showInputDialog("Enter your First Point (the longer the better):");
        String key4 = JOptionPane.showInputDialog("Enter your Second Point (the longer the better):");
        if(key3.equals(key1) && key4.equals(key2))
        {
        ...
        {
            JOptionPane.showMessageDialog(null, "Keys are incorrect");
        }
