 ...
 * @author 
 */
public class EmbedForm1 extends javax.swing.JFrame {
EmbProcess ep;
...
ResultSet rs=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s = new String();
            ...
            filedialog.getFile();
            jLabel6.setText(filedialog.getFile());
   ...
   return true;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         try
		{
        String key = JOptionPane.showInputDialog("Enter your First Point (the longer the better):");
        String key1 = JOptionPane.showInputDialog("Enter your Second Point (the longer the better):");
       int a=Integer.parseInt(key);
       int b=Integer.parseInt(key1);
	  ...
	  genfile = ep.emb(s2,s1);
       ...
       st=frm.getCon().createStatement();
        ...
        st.execute("insert into emd_file(key1,key2,genfile) values('"+key+"','"+key1+"','"+genfile+"')");
        ...
        JOptionPane.showMessageDialog(null,"Given Number is not Prime The Eliptical Curve is not Generated!!!!");
	}
        }
         catch(Exception e)
      {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmbedForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmbedForm1().setVisible(true);
            }
        });
    }
